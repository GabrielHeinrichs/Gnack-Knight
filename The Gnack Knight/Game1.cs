...
using Microsoft.Xna.Framework.Graphics;
using The_Gnack_Knight.Classes;
using The_Gnack_Knight.Classes.GameState;
...
namespace The_Gnack_Knight
{
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            // Add GameplayState as the active state
            stateManager.ChangeState(new MainMenuState(stateManager, Content, spriteBatch, textures, graphics));
